...
<body class="font-sans scroll-smooth">
    ...
    <div class="flex flex-col items-center justify-center bg-black bg-opacity-70 w-full h-full z-50 fixed hidden"
        id="data-loading">
    ...
    <div class="min-h-screen bg-white">
        ...
        <header class="bg-gray-50">
            <div class="w-full max-w-7xl mx-auto pt-4 pb-8 px-5 md:px-0">
                {{ $header }}
            </div>
        </header>

        <!-- Page Content -->
        <main class="w-full max-w-7xl mx-auto py-10 px-5 md:px-0">
            {{ $slot }}
        </main>
    </div>
